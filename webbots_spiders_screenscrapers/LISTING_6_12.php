...
<p class="text">This web page is a tool to diagnose webbot functionality
	by examining what the webbot sends to webservers.
<table border="1" cellspacing="0" cellpadding="3" width="800">
	...
	<tr>
		...
		<td><?echo $_SERVER["REQUEST_METHOD"];?>
		</td>
	</tr>
	<tr>
		<td>Your IP Address</td>
		<td><?echo $_SERVER["REMOTE_ADDR"];?>
		</td>
	</tr>
	<tr>
		<td>Server Port</td>
		<td><?echo $_SERVER["SERVER_PORT"];?>
		</td>
	</tr>
	<tr>
		<td>Referer</td>
...
<p class="text">This web page also sets a diagnostic cookie, which
	should be visible the second time you access this page.</p>
